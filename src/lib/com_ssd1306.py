...
class SSD1306:
    ...
    def __init__(self):
        ...
        self.__bigFont = ImageFont.truetype('font/FreeSans.ttf', 19)
        self.__extraFont = ImageFont.truetype('font/FreeSans.ttf', 19)
    ...
    def text(self, x, y, text, fontheight):
        if SMBus is not None:
            ...
            if fontheight == self.EXTRA_FONT:
                draw.text((x, y), text, font = self.__extraFont, fill = 1)
